...
# =========================================================================
# 1. CONFIGURAÇÃO DA PÁGINA & CSS DESIGN SYSTEM: CONTRASTE ABSOLUTO
# =========================================================================
st.set_page_config(
...
<style>
    ...
    /* =========================================================
       BOTÕES DA BARRA LATERAL: SIMETRIA RIGOROSA E CONTRASTE
       ========================================================= */
    ...
    /* =========================================================
       CORREÇÃO ABSOLUTA: BOTÕES CLAROS / BRANCOS
       FORÇAMENTO DE FONTE ESCURA (PRETO ÔNIX) EM TODAS AS TAGS
       ========================================================= */
    /* Aplica em botões brancos de formulários e botões claros globais */
    div[data-testid="stForm"] div.stButton > button,
    div.stButton > button[kind="secondaryFormSubmit"],
    .botao-branco > div.stButton > button {
    ...
    /* Forçamento profundo no texto de botões claros */
    div[data-testid="stForm"] div.stButton > button,
    div[data-testid="stForm"] div.stButton > button *,
    div[data-testid="stForm"] div.stButton > button p,
    div[data-testid="stForm"] div.stButton > button span,
    div[data-testid="stForm"] div.stButton > button div {
    ...
    /* Caixas de Texto do Formulário VIP (Caixa branca com texto preto nítido) */
    ...
    /* =========================================================
       BOTÕES PRINCIPAIS DE AÇÃO (FUNDO AZUL COM FONTE BRANCA)
       ========================================================= */
...
# =========================================================================
# BARRA LATERAL À DIREITA COM BOTÕES SIMÉTRICOS
# =========================================================================
with st.sidebar:
...
def renderizar_barreira_lead(titulo_area):
    ...
    with col_center:
        with st.form("form_captura_lead"):
            ...
            # BOTÃO COM FONTE ESCURA (PRETO ÔNIX) EM MÁXIMO CONTRASTE NO FUNDO BRANCO
...
# =========================================================================
# MÓDULO 2: ASSISTENTE I.A
# =========================================================================
elif st.session_state.modulo_atual == "🤖 Assistente I.A":
...
# =========================================================================
# MÓDULO 3: ANÁLISE PRÉ-JOGO (ÁREA VIP)
# =========================================================================
...
# =========================================================================
# MÓDULO 4: BACKTEST 5 ANOS (ÁREA VIP)
# =========================================================================
...
# =========================================================================
# MÓDULO 6: CALCULADORA EV+ & CRITÉRIO DE KELLY
# =========================================================================
